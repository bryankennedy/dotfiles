...
**Not done here.** Host-level filtering on the Mac was considered and is out of scope for this service. The assessment is in the private infrastructure repo's `docs/security-findings.md`.
