...
description: Verify a feature or bug fix by opening the local dev server in a browser. Use when the user asks to test, verify, or confirm a UI change or browser-visible behavior.
---
